package com.CPAN_228_Group10.CPAN_228_FinalProject.humber.warehouse.config;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        distributionCentreItemRepository.deleteAll();
        distributionCentreRepository.deleteAll();
        itemRepository.deleteAll();
        
        boolean isDevProfile = environment.acceptsProfiles(org.springframework.core.env.Profiles.of("dev"));
    ...
    private void initializeQaData() {
        ...
        Item pants = new Item("Pants", Brand.STONE_ISLAND, 2024, 1300.00);
        Item sweater = new Item("Sweater", Brand.DIOR, 2022, 2200.00);
        Item shoes = new Item("Shoes", Brand.BALENCIAGA, 2023, 2500.00);
        Item hat = new Item("Hat", Brand.STONE_ISLAND, 2023, 800.00);
        ...
        itemRepository.save(hat);

        DistributionCentre dc1 = new DistributionCentre();
        dc1.setName("Toronto QA Distribution Centre");
        dc1.setLatitude(43.6532);
        dc1.setLongitude(-79.3832);
        distributionCentreRepository.save(dc1);

        DistributionCentre dc2 = new DistributionCentre();
        dc2.setName("Vancouver QA Distribution Centre");
        dc2.setLatitude(49.2827);
        dc2.setLongitude(-123.1207);
        distributionCentreRepository.save(dc2);

        DistributionCentre dc3 = new DistributionCentre();
        dc3.setName("Montreal QA Distribution Centre");
        dc3.setLatitude(45.5017);
        dc3.setLongitude(-73.5673);
        distributionCentreRepository.save(dc3);
        ...
        DistributionCentreItem dci4 = new DistributionCentreItem();
        dci4.setDistributionCentre(dc1);
        dci4.setItem(shoes);
        dci4.setQuantity(10);
        distributionCentreItemRepository.save(dci4);

        DistributionCentreItem dci5 = new DistributionCentreItem();
        dci5.setDistributionCentre(dc2);
        dci5.setItem(hat);
        dci5.setQuantity(30);
        distributionCentreItemRepository.save(dci5);
    }
}
